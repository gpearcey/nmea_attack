...
///
/// Makes the boat look like it is moving in the opposite direction
pub fn attack_1(msg: NMEAMsg) -> NMEAMsg{
...
/// Modifies a message if it contains positional data
///
/// Performs a translation of the boat's position, maintains heading
pub fn attack_2(msg: NMEAMsg) -> NMEAMsg{
